                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Data <span class="table-project-n">User</span> Pengunjung</h1>
                        </div>
                    </div>
                    ...
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <div class="btn-group btn-custom-groups">
                                  <a href="datamahasiswa"> <button type="button" class="btn btn-warning" ><i class="fa fa-plus" aria-hidden="true"></i> Tambah Mahasiswa</button> </a>
                            </div>
                            <div class="btn-group btn-custom-groups">
                                  <a href="datadosen"> <button type="button" class="btn btn-warning" ><i class="fa fa-plus" aria-hidden="true"></i> Tambah Dosen</button> </a>
                            </div>
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="false" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="nip" data-editable="false">NIP/NPT/NPM</th>
                                        ...
                                        <th data-field="action"><center>Hapus</center></th>
                                    </tr>
                                </thead>
                                <tbody>
@if(isset($result))
...
@php
$no++;
$id_user=$datamas->id_users;
$id_mas=$datamas->id_mahasiswa;
$nip=$datamas->npm;
$nama=$datamas->nama;
$alamat=$datamas->alamat;
$no_telp=$datamas->no_telp;
$email=$datamas->email;
...
@endphp
                                    <tr>
                                        ...
                                        <td>
                                          <div class="btn-group btn-custom-groups">
                                            <form action="{{ url('masdeletePost') }}" method="post">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="nama" class="form-control" value="{{ $nama }}">
                                                <input type="hidden" name="id_user" class="form-control" value="{{ $id_user }}">
                                                <input type="hidden" name="id_mas" class="form-control" value="{{ $id_mas }}">
                                                      <button type="submit" class="btn btn-warning" onclick="return confirm('Data Pengunjung {{ $nama }} Akan Dihapus ?');"><i class="fa fa-trash" aria-hidden="true"> Hapus</i></button>
                                            </form>
                                          </div>
                                        </td>
                                    </tr>
...
@php
$no++;
$id_user=$datados->id_users;
$id_dosen=$datamas->id_dosen;
$nip=$datados->nip;
$nama=$datados->nama;
$alamat=$datados->alamat;
$no_telp=$datados->no_telp;
$email=$datados->email;
$jabatan="Dosen : ".$datados->nama_progdi;
@endphp
                                    <tr>
                                        <td></td>
                                        <td>{{ $no }}</td>
                                        ...
                                        <td>{{ $email }}</td>
                                          <td>
                                            <div class="btn-group btn-custom-groups">
                                              <form action="{{ url('dosdeletePost') }}" method="post">
                                                  {{ csrf_field() }}
                                                  <input type="hidden" name="nama" class="form-control" value="{{ $nama }}">
                                                  <input type="hidden" name="id_user" class="form-control" value="{{ $id_user }}">
                                                  <input type="hidden" name="id_dosen" class="form-control" value="{{ $id_dosen }}">
                                                        <button type="submit" class="btn btn-warning" onclick="return confirm('Data Pengunjung {{ $nama }} Akan Dihapus ?');"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                              </form>
                                            </div>
                                          </td>
                                    </tr>

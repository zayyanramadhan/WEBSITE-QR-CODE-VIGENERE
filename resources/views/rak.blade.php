                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <h1>Data <span class="table-project-n">Kode Rak</span></h1>
                        </div>
                    </div>
                    <div class="sparkline13-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <div class="btn-group btn-custom-groups">
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#WarningModalhdbgcl"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Kode Rak</button>
                            </div>
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="false" data-resizable="false" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="kode"><center>Kode Rak</th>
...
@endphp
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <div class="modal-dialog">
                                              <div class="modal-content">
                                                  <div class="modal-header header-color-modal bg-color-3">
                                                      <h4 class="modal-title">Edit Kode Rak</h4>
                                                      <div class="modal-close-area modal-close-df">
                                                          <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                                                      </div>
                                                  </div>
                                                  <form name="frm_edit{{ $no }}" id="frm_edit{{ $no }}" role="form" method="post" action="{{ url('rakupdatePost') }}">
                                                          ...
                                                          <div class="row">
                                                            <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12"></div>
                                                              <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                                  <label class="login2 pull-right pull-right-pro">Kode Rak</label>
                                                              </div>
                                                              <div class="input-group date">
                                                                  <input type="text" id="kode" name="kode" class="form-control" value="{{ $kode }}" placeholder="Kode Rak">
                                                              </div>
                                                              <div id="vkode_e{{ $no }}" class="alert alert-danger alert-mg-b alert-st-four" role="alert" style="display:none">
                                                                  <p class="message-mg-rt">Kode Rak belum diisi</p>
                                                              </div>
                                                          </div>
                                          ...
                                          <div class="btn-group btn-custom-groups">
                                            <form action="{{ url('rakdeletePost') }}" method="post">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="id" class="form-control" value="{{ $id }}">
                                                      <button type="submit" class="btn btn-warning" onclick="return confirm('Data Kode Rak {{ $kode }} Akan Dihapus ?');"><i class="fa fa-trash" aria-hidden="true"></i></button>
                                            </form>
                                          </div>
                                        </center>
                                        </td>
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header header-color-modal bg-color-3">
            <h4 class="modal-title">Tambah Kode Rak</h4>
            <div class="modal-close-area modal-close-df">
                <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
            </div>
        </div>
        <form name="frm" id="frm" role="form" method="post" action="{{ url('rakaddPost') }}">
        <div class="modal-body">
            <span class="adminpro-icon adminpro-warning-danger modal-check-pro information-icon-pro"></span>
              {{ csrf_field() }}
              <div class="row">
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-12"></div>
                  ...
                  <div class="input-group date">
                      <input type="text" id="kode" name="kode" class="form-control" value="" placeholder="Kode Rak">
                  </div>
                  <div id="vkode" class="alert alert-danger alert-mg-b alert-st-four" role="alert" style="display:none">
                      <p class="message-mg-rt">Kode Rak belum diisi</p>
                  </div>
              </div>
...
function getval()
{
var vkode = document.getElementById("vkode");
cek = 0;

if(frm.kode.value=="")
{
vkode.style.display = "block";
cek = 1;
}
else {
vkode.style.display = "none";
}
if (cek == 0)
{
return true;
...
{
  var vkode_e{{ $nov }} = document.getElementById("vkode_e{{ $nov }}");
  cek = 0;


  if(frm_edit{{ $nov }}.kode.value=="")
  {
  vkode_e{{ $nov }}.style.display = "block";
  cek = 1;
  }
  else {
  vkode_e{{ $nov }}.style.display = "none";
  }
  if (cek == 0)
  {
  return true;
